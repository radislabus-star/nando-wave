...
|   |   +-- next_payload_ready_gaps                  [git_control, serving_ops, retrieval_lookup]
...
|   |   +-- false_accepts                            [0]
|   |   +-- market claim boundary                    [not savings; local_accepts_enabled=false; singleton true support is not promotable]
...
|   +-- current default feedback after metrics_report evidence [REVIEW, 8/1000]
|   |   |
