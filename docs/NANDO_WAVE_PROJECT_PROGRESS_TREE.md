...
|   +-- real traffic routability / savings claim     [REVIEW, current default 12/1000; historical strongest 17/1000]
|   |   |
|   |   +-- source                                  [non-synthetic Codex history trace]
|   |   +-- current default verified CPU accepts     [12 / 1000]
|   |   +-- historical strongest verified CPU accepts [17 / 1000]
|   |   +-- exact_cache_hits                         [53]
|   |   +-- current default operator_candidate_calls [427]
|   |   +-- current default scoreable_candidate_calls [167]
...
|   +-- metrics_report 5000-row safe-policy soak    [REVIEW, 3 verified but 1 unverified accept]
|   |   |
...
|   |   +-- next_debt                                [recover missing evidence or request-side reject the unverified row]
...
|   +-- current default feedback after read_inspect + metrics_report calibration + git_control safe-policy + serving_ops safe-policy [REVIEW, 12/1000]
|   |   |
