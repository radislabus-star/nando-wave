...
|   |   +-- git_control_route_status                 [payload/profile integrated; verifier missing]
...
|   +-- git_control route/profile rung              [REVIEW, scoreable, verifier missing]
|   |   |
...
|   |   +-- verified_cpu_accept_eligible_events      [0]
|   |   +-- market claim boundary                    [not savings; no git command execution; verifier missing]
...
|   +-- current default feedback after read_inspect + metrics_report calibration + git_control profile [REVIEW, 8/1000]
|   |   |
