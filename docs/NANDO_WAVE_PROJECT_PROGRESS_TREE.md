...
|   |   +-- local_accepts_enabled                     [false]
|   |   +-- market_claim_allowed                      [false]
|   |   +-- boundary                                  [complete disabled route rung; does not change current 16/1000 unique CPU scoreboard]
...
|   +-- current default feedback after read_inspect + metrics_report calibration + agent-control v2 safe-policy + mixed v2 safe-policy + git_control safe-policy + serving_ops safe-policy [REVIEW, unique 16/1000]
|   |   |
