...
|   +-- real traffic routability / savings claim     [REVIEW, current default unique 12/1000; v3 diagnostic unique 16/1000]
|   |   |
|   |   +-- source                                  [non-synthetic Codex history trace]
|   |   +-- current default verified CPU route-sum accepts [12 / 1000]
|   |   +-- current default unique verified CPU accepts [12 / 1000]
...
|   |   +-- current default scoreable_candidate_calls [170]
|   |   +-- current default verification_hook_ready_events [130]
|   |   +-- false_accepts                            [0]
|   |   +-- current default verified_gap_to_80_calls [788]
|   |   +-- current default agent-control route      [visible row: 143 candidates, 3 verified]
...
|   |   +-- market claim boundary                    [not achieved; current default 12 milli != 800 milli]
...
|   +-- current default feedback after read_inspect + metrics_report calibration + agent-control safe-policy + git_control safe-policy + serving_ops safe-policy [REVIEW, unique 12/1000]
|   |   |
...
|   |   +-- unique_verified_cpu_accepts              [12]
|   |   +-- incremental_unique_cpu_accepts           [12]
...
|   |   +-- agent_control_stage                      [verified_cpu_accept_eligible; 143 candidates, 3 accepts]
