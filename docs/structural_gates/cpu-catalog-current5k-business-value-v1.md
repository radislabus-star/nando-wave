...
| current5k_catalog | incremental_unique_accepts | 95 | `cpu-operator-catalog-v1-current5k.combined.report.json` |
| current5k_catalog | gap_to_cpu80_calls | 3905 | `cpu-route-feedback-loop-v1-current5k.combined.report.json` |
| current5k_catalog | proven_profile_rows | 3 | `cpu-operator-catalog-v1-current5k.combined.report.json` |
...
| serving_ops_profile | shelf | PROVEN_TINY_SUPPORT | `cpu-operator-catalog-v1-current5k.combined.report.json` |
| serving_ops_profile | incremental_unique_accepts | 1 | `cpu-operator-catalog-v1-current5k.combined.report.json` |
