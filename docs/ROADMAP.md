...
Главный goal-контракт проекта находится в `docs/GOAL.md`. Если roadmap и
эксперимент спорят с `docs/GOAL.md`, сначала обновляется goal-контракт или
эксперимент уходит в `docs/PARKING_LOT.md`.
