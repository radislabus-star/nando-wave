...
```text
compiled_operator_keys: 96
compiled_slot_centers: 1193
heldout_rows: 1536
decoded_rows: 1536
heldout_accuracy_milli: 667
wrong_exact_rows: 0
same_bag_output_milli: 1000
median_min_slot_margin: 0.0
p10_min_slot_margin: 0.0
```

Local-only decoder boundary:

```text
heldout_accuracy_milli: 333
wrong_exact_rows: 0
...
```text
compiled_operator_keys: 8
compiled_slot_centers: 108
