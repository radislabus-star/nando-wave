...
| s4 | V4 candidate | may_change_only | cfg(test) measurement with identical production projection | runtime preservation | 1.0 | candidate source | production projection | candidate | s1c3-v4 | build | S1C3 V4 owner | final freeze | no runtime delta | plans/effect-law-unification-v1/S1C_TRANSACTIONAL_DEPLOYMENT_PREREGISTRATION_V4.md:32 | S1C-3 V4 |
...
| c4 | V4 candidate | may_change_only | cfg(test) measurement with identical production projection | accepted runtime-preservation repair | 1.0 | candidate source | production projection | candidate | s1c3-v4 | build | S1C3 V4 owner | final freeze | no runtime delta | plans/effect-law-unification-v1/S1C_TRANSACTIONAL_DEPLOYMENT_PREREGISTRATION_V4_CRITIQUE.md:11 | S1C-3 V4 |
