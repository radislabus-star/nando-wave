...
pub(crate) fn grounded_program_family_id(
    frame: &RelationFrame,
...
pub(crate) fn compile_independent_verifier(
...
pub(crate) fn program_runtime_applicable(
    program: &ResponseProgram,
...
mod tests {
    use super::*;
    use crate::{
        AtomSource, AtomValueType, ProjectStatusMapping, RELATION_FRAME_SCHEMA,
        ResponseValueSelector, SOURCE_NEUTRAL_EXTRACTOR_VERSION, ValueProjectionFormat,
    };
