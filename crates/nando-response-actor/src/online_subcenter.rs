...
pub(crate) struct CleanSubcenter {
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub(crate) struct OnlineSubcenterDiscovery {
...
impl OnlineSubcenterDiscovery {
    pub(crate) fn observe(&mut self, action: &str, atom_ids: &[u64], tokens: u64) {
    ...
    pub(crate) fn bytes_estimate(&self) -> usize {
        self.atoms
            .len()
            .saturating_mul(64)
