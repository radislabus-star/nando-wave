...
pub use wave::{
    ...
    PackedTransition32, PeakOutcome, PhaseCenterCell, PhaseCenterCompiler, PhaseCenterEvalTask,
    ...
    WavePredictorHebbianUpdateReport, WavePredictorMarginSchedule,
    WavePredictorRoleBindingDecision, WavePredictorRoleBindingEvalTask,
    WavePredictorRoleBindingOffloadAction, WavePredictorRoleBindingOffloadPolicy,
    WavePredictorRoleBindingOffloadRuntime, WavePredictorRoleBindingOffloadSummary,
    WavePredictorRoleBindingPackageError, WavePredictorRoleBindingPackageInfo,
    WavePredictorRoleBindingPreparedFringe, WavePredictorStateDeltaTarget,
    ...
    phase_margin_from_centers, phase_margin_to_micro, phase_vector_from_atoms,
    ...
    semantic_label_slot, stable_phase_cell, stage2_organ, surface_atom_projection, surface_atoms,
