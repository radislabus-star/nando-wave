...
pub use wave::{
    ...
    PHASE_CENTER_RUNTIME_PACKAGE_MAGIC, PHASE_SLOTS, PLANNED_ORGAN128_BYTES,
    PLANNED_ORGAN128_CELLS, PLANNED_ORGAN192_BYTES, PackedInterference32, PackedMode32,
    PackedTransition32, PeakOutcome, PhaseCenterAtomEncoder, PhaseCenterCell, PhaseCenterCompiler,
    PhaseCenterEvalTask, PhaseCenterFlatRecord, PhaseCenterFlatRuntime,
    PhaseCenterHotCandidateDecision, PhaseCenterHotDecision, PhaseCenterHotEvidenceRequest,
    PhaseCenterHotProfile, PhaseCenterHotRequest, PhaseCenterHotRequestEvidence,
    PhaseCenterHotRoutePlan, PhaseCenterHotRouteTable, PhaseCenterHotRowPreparer,
    PhaseCenterHotRuntime, PhaseCenterHotScratch, PhaseCenterHotShadowEval, PhaseCenterHotWorker,
    PhaseCenterLiveOperatorAtomEvent, PhaseCenterLiveOperatorStore,
    ...
    PhaseCenterOffloadSummary, PhaseCenterOnlineCandidatePackage, PhaseCenterOnlineDecision,
    PhaseCenterOnlineMinerConfig, PhaseCenterOperatorAdmission,
    PhaseCenterOperatorAdmissionBlocker, PhaseCenterOperatorAdmissionDecision,
    PhaseCenterOperatorMemory, PhaseCenterOperatorMemoryConfig, PhaseCenterPreparedHotDenominator,
    ...
    PhaseCenterRuntimePackageInfo, PhaseCenterThresholdPolicyEvidence, PhaseCenterVerifierBinding,
    ProjectionEntry16, SEMANTIC_OPERATOR_BYTES, SEMANTIC_WAVE_BYTES, SEMANTIC_WAVE_DIM,
    SNAPSHOT_TOP_SLOTS, SNAPSHOT_V1_BYTES, STAGE2_ORGAN_CELLS, STAGE2_TOP_K, SURFACE_FOURIER_BINS,
    SURFACE_WAVE_BYTES, SURFACE_WAVE_DIM, SURFACE_WAVE_LM_BIAS_BYTES, SURFACE_WAVE_LM_OUTPUTS,
    ...
    Stage2TraceTick, SurfaceAtom, SurfaceFourierSignature, SurfaceMotif, SurfaceMotifBank,
    SurfaceMotifRef, SurfaceMotifSpec, SurfaceResidualRecord, SurfaceWave4096, SurfaceWaveCenter,
    ...
    WAVEPREDICTOR_STATE_DELTA_CAP, WAVEPREDICTOR_TARGET_AXIS_CAP, WaveBus,
    WavePatternCompileReport, WavePatternCompiler, WavePatternSelection, WavePatternTemplate,
    WavePredictorActiveCenter, WavePredictorAxisTarget, WavePredictorCenterId,
    WavePredictorCompositionalTrainTask, WavePredictorConvergenceError, WavePredictorEpochReport,
    WavePredictorHebbianConfig, WavePredictorHebbianEdge, WavePredictorHebbianField,
    WavePredictorHebbianUpdateReport, WavePredictorMarginSchedule, WavePredictorStateDeltaTarget,
    WavePredictorStateDeltaTrainTask, WavePredictorStateImpulse, WavePredictorTrainTask,
    WavePredictorTrainer, WavePredictorTrainerConfig, WavePredictorTrainerReport, add_phase_vector,
    encode_byte_phases, phase_center_from_sum, phase_circular_unit, phase_coherence,
    phase_margin_from_centers, phase_margin_to_micro, phase_vector_from_atom_ids,
    phase_vector_from_atoms, run_stage2_bus_trace_with_organ_carrier, run_stage2_tick,
    ...
    run_stage2_trace_with_organ_lut_carrier, semantic_label_slot, stable_phase_cell, stage2_organ,
    surface_atom_projection, surface_atoms, surface_ngram_count, surface_ngram_projection,
};
