...
#[doc(hidden)]
pub fn retryable_adapter_unseparable(blocker: &str, required_rows: usize) -> bool {
...
mod tests {
    ...
    fn ready_forest_routes_around_a_terminal_edge() {
        ...
        graph
            ...
            .expect("terminal edge rejection should succeed");
    ...
    fn startup_reopens_only_under_evidenced_rejections() {
        ...
        graph
            ...
            .expect("retryable edge rejection should succeed");
