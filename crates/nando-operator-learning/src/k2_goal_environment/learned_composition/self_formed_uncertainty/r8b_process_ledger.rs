...
use super::{
    ...
    K2UncertaintyR8BExpectedOutcomeV3, K2UncertaintyR8BInputRoleV3,
    K2UncertaintyR8BInvocationPlanV3, K2UncertaintyR8BLedgerHeaderV3, K2UncertaintyR8BLedgerSealV3,
    K2UncertaintyR8BLedgerSummaryV3, K2UncertaintyR8BOutputContractV3,
    K2UncertaintyR8BProcessEventKindV2, K2UncertaintyR8BProcessEventV2,
    K2UncertaintyR8BProcessEventV3, K2UncertaintyR8BProcessLedgerV2,
    K2UncertaintyR8BProducedReceiptV2, K2UncertaintyR8BProducerRequestV3,
    K2UncertaintyR8BScheduleAuthorityV3, K2UncertaintyR8BValidatedFactV3,
    K2UncertaintyR8BValidatedOutputV3, append_canonical_jsonl_v1, canonical_jsonl_line_v1,
    create_exclusive_file_v1, decode_canonical_json_v1, open_nofollow_file_v1,
    publish_immutable_file_v1, read_bounded_jsonl_line_v1, read_immutable_file_v1,
    recover_renamed_file_v1, rename_noreplace_same_device_v1, require_private_directory_v1,
    seal_self_formed_r8b_process_event_v3, sync_directory_v1, uncertainty_bytes_v1,
    uncertainty_decode_v1, uncertainty_root_v1, validate_regular_file_v1,
    validate_self_formed_r8b_schedule_authority_v3,
};

#[path = "r8b_process_ledger/stream.rs"]
mod stream;

pub use stream::{
    validate_self_formed_r8b_ledger_header_v3, validate_self_formed_r8b_ledger_seal_v3,
    validate_self_formed_r8b_ledger_stream_attested_v3, validate_self_formed_r8b_ledger_stream_v3,
};
...
impl K2UncertaintyR8BLedgerWriterV3 {
    ...
    pub fn failure(
        ...
        let completion = if completion == K2UncertaintyR8BCompletionKindV3::UnexpectedFailure
            && started.invocation.expected_outcome
                == K2UncertaintyR8BExpectedOutcomeV3::DiagnosticExpectedFailure
            && started
                .invocation
                .expected_exit_predicate
                .as_ref()
                .is_some_and(|predicate| predicate.exact_exit_code == exit_code)
        {
