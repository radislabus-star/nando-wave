...
use crate::{
    EconomicsReceipt, RuntimeFrame, RuntimeParityCase, TEACHER_OUTCOME_SCHEMA_V1,
    TEACHER_TRANSITION_SCHEMA_V1, TeacherActionAst, TeacherOutcome, TeacherTransition,
    TeacherVerifierEvidence, relation_atom_is_teacher_only,
};
...
#[doc(hidden)]
pub fn action_schema_enriched_frame(
    frame: &RelationFrame,
