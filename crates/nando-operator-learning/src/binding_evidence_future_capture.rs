...
use crate::{
    EVIDENCE_LEDGER_SCHEMA_V1, EvidenceIngestOutcome, EvidenceLedgerRecord, evidence_payload_sha256,
};
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[doc(hidden)]
pub struct BindingFutureCaptureRowV1 {
    schema: String,
    row_sha256: String,
    protocol_receipt_sha256: String,
    slot_id: String,
...
impl BindingFutureCaptureFreezeV1 {
    ...
    #[doc(hidden)]
    pub fn future_label_rows(&self) -> &[BindingFutureCaptureRowV1] {
        &self.future_rows
    }

    #[doc(hidden)]
    pub fn protocol(&self) -> &BindingFutureAcquisitionProtocolV1 {
        &self.protocol
    }
}
