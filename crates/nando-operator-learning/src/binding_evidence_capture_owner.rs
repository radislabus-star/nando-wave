...
use crate::{EVIDENCE_LEDGER_SCHEMA_V1, EvidenceIngestOutcome, EvidenceLedgerRecord};
...
impl BindingSupportFreezeV1 {
    ...
    #[doc(hidden)]
    pub fn support_capture_records(&self) -> Vec<&EvidenceLedgerRecord> {
        self.support_rows
            .iter()
    ...
    #[doc(hidden)]
    pub fn support_session_lineage_sha256s(&self) -> BTreeSet<String> {
        self.support_rows
            .iter()
            .map(|row| row.session_lineage_sha256.clone())
            .collect()
    ...
    #[doc(hidden)]
    pub fn support_label_rows(&self) -> &[BindingSupportCaptureRowV1] {
        &self.support_rows
    }
}
...
impl BindingSupportCaptureRowV1 {
    #[doc(hidden)]
    pub fn frozen_graph(&self) -> &FrozenCandidateRelationGraphV1 {
        &self.frozen_graph
    }

    #[doc(hidden)]
    pub fn capture_receipt(&self) -> &CaptureEvidenceReceipt {
        &self.capture_receipt
    }

    #[doc(hidden)]
    pub fn capture_record(&self) -> &EvidenceLedgerRecord {
        &self.capture_record
    }

    #[doc(hidden)]
    pub fn pre_action_wire_root_sha256(&self) -> &str {
        &self.pre_action_wire_root_sha256
    }

    #[doc(hidden)]
    pub fn intervention_id(&self) -> &str {
        &self.intervention_id
    }

    #[doc(hidden)]
    pub fn session_lineage_sha256(&self) -> &str {
