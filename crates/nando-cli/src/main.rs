...
use role_binding_runtime_cmd::{
    ...
    run_role_binding_real_traffic_agent_continue_execute_state_admission_audit_v1,
    ...
    run_role_binding_real_traffic_agent_loop_profile_registry_v1,
    run_role_binding_real_traffic_answer_evidence_admission_calibration_v1,
    ...
    run_role_binding_real_traffic_conditional_safe_policy_promote_v1,
    ...
    run_role_binding_real_traffic_edit_safe_policy_promote_v2,
    ...
    run_role_binding_real_traffic_git_control_admission_audit_v1,
    ...
    run_role_binding_real_traffic_ime_input_state_profile_v1,
    run_role_binding_real_traffic_ingest_events_v1,
    run_role_binding_real_traffic_manual_route_discovery_v1,
    run_role_binding_real_traffic_metrics_report_admission_calibration_v1,
    run_role_binding_real_traffic_metrics_report_admission_safe_policy_promote_v1,
    ...
    run_role_binding_real_traffic_metrics_report_safe_policy_promote_v1,
    run_role_binding_real_traffic_mixed_admission_audit_v1,
    ...
    run_role_binding_real_traffic_mixed_safe_policy_promote_v2,
    run_role_binding_real_traffic_mixed_safe_policy_promote_v3,
    run_role_binding_real_traffic_planning_next_step_admission_calibration_v1,
    run_role_binding_real_traffic_planning_next_step_artifact_progress_v1,
    run_role_binding_real_traffic_planning_next_step_local_accept_calibration_v1,
    ...
    run_role_binding_real_traffic_resource_pressure_output_evidence_v1,
    run_role_binding_real_traffic_resource_pressure_payload_dry_run_v1,
    run_role_binding_real_traffic_retrieval_lookup_local_accept_calibration_v1,
...
fn main() -> ExitCode {
    ...
    match command.as_deref() {
        ...
        Some("role-binding-real-traffic-manual-route-discovery-v1") => exit_for_result(
            run_role_binding_real_traffic_manual_route_discovery_v1(args),
            "try: nando-cli role-binding-real-traffic-manual-route-discovery-v1 [history-jsonl] [route-gap-readiness-report-json] [discovery-report-json]",
        ),
        Some("role-binding-real-traffic-resource-pressure-payload-dry-run-v1") => exit_for_result(
            run_role_binding_real_traffic_resource_pressure_payload_dry_run_v1(args),
            "try: nando-cli role-binding-real-traffic-resource-pressure-payload-dry-run-v1 [history-jsonl] [registry-config-json] [manual-discovery-report-json] [trace-jsonl] [report-json] [max-events]",
        ),
        ...
        Some("role-binding-real-traffic-ime-input-state-payload-dry-run-v1") => exit_for_result(
            ...
            "try: nando-cli role-binding-real-traffic-ime-input-state-payload-dry-run-v1 [history-jsonl] [registry-config-json] [manual-discovery-report-json] [trace-jsonl] [report-json] [max-events]",
        ),
        Some("role-binding-real-traffic-ime-input-state-profile-v1") => exit_for_result(
            run_role_binding_real_traffic_ime_input_state_profile_v1(args),
            "try: nando-cli role-binding-real-traffic-ime-input-state-profile-v1 [base-registry-json] [ime-input-state-dry-run-trace-jsonl] [ime-input-state-package-nwrb] [overlay-registry-json] [profile-report-json]",
        ),
        Some("role-binding-real-traffic-ime-input-state-output-evidence-v1") => exit_for_result(
            run_role_binding_real_traffic_ime_input_state_output_evidence_v1(args),
            "try: nando-cli role-binding-real-traffic-ime-input-state-output-evidence-v1 [ime-input-state-dry-run-trace-jsonl] [sessions-root] [output-trace-jsonl] [evidence-report-json]",
        ),
        Some("role-binding-real-traffic-ime-input-state-admission-audit-v1") => exit_for_result(
            run_role_binding_real_traffic_ime_input_state_admission_audit_v1(args),
            "try: nando-cli role-binding-real-traffic-ime-input-state-admission-audit-v1 [ime-input-state-output-evidence-trace-jsonl] [history-jsonl] [admission-audit-report-json]",
        ),
        Some("role-binding-real-traffic-answer-evidence-payload-dry-run-v1") => exit_for_result(
            run_role_binding_real_traffic_answer_evidence_payload_dry_run_v1(args),
            "try: nando-cli role-binding-real-traffic-answer-evidence-payload-dry-run-v1 [history-jsonl] [registry-config-json] [trace-jsonl] [dry-run-report-json] [max-events]",
        ),
        ...
        Some("role-binding-real-traffic-test-output-parse-output-evidence-v1") => exit_for_result(
        ...
        Some("role-binding-real-traffic-test-output-parse-tool-state-payload-v1") => {
            exit_for_result(
                run_role_binding_real_traffic_test_output_parse_tool_state_payload_v1(args),
                "try: nando-cli role-binding-real-traffic-test-output-parse-tool-state-payload-v1 [tool-state-report-json] [registry-config-json] [trace-jsonl] [report-json]",
            )
        }
        Some("role-binding-real-traffic-test-output-parse-profile-v1") => exit_for_result(
            run_role_binding_real_traffic_test_output_parse_profile_v1(args),
            "try: nando-cli role-binding-real-traffic-test-output-parse-profile-v1 [base-registry-json] [tool-state-payload-trace-jsonl] [package-nwrb] [overlay-registry-json] [profile-report-json]",
        ),
        Some("role-binding-real-traffic-test-output-parse-safe-policy-promote-v1") => {
            exit_for_result(
        ...
        Some("role-binding-real-traffic-file-path-evidence-output-evidence-v1") => exit_for_result(
        ...
        Some("role-binding-real-traffic-answer-evidence-output-evidence-v1") => exit_for_result(
        ...
        Some("role-binding-real-traffic-answer-evidence-admission-calibration-v1") => {
            exit_for_result(
                run_role_binding_real_traffic_answer_evidence_admission_calibration_v1(args),
                "try: nando-cli role-binding-real-traffic-answer-evidence-admission-calibration-v1 [evidence-trace-jsonl] [history-jsonl] [admission-report-json]",
            )
        }
        ...
        Some("role-binding-real-traffic-agent-continue-execute-local-accept-calibration-v1") => {
            exit_for_result(
                run_role_binding_real_traffic_agent_continue_execute_local_accept_calibration_v1(
                    args,
                ),
        ...
        Some("role-binding-real-traffic-agent-continue-execute-state-admission-audit-v1") => {
            exit_for_result(
                run_role_binding_real_traffic_agent_continue_execute_state_admission_audit_v1(args),
                "try: nando-cli role-binding-real-traffic-agent-continue-execute-state-admission-audit-v1 [artifact-progress-trace-jsonl] [codex-sessions-root] [audit-report-json]",
            )
        }
        Some("role-binding-real-traffic-read-inspect-payload-dry-run-v1") => exit_for_result(
            ...
            "try: nando-cli role-binding-real-traffic-read-inspect-payload-dry-run-v1 [history-jsonl] [registry-config-json] [trace-jsonl] [dry-run-report-json] [max-events]",
        ),
        ...
        Some("role-binding-real-traffic-retrieval-lookup-local-accept-calibration-v1") => {
            exit_for_result(
                run_role_binding_real_traffic_retrieval_lookup_local_accept_calibration_v1(args),
                "try: nando-cli role-binding-real-traffic-retrieval-lookup-local-accept-calibration-v1 [registry-config-json] [evidence-trace-jsonl] [calibration-report-json]",
            )
        }
        ...
        Some("role-binding-real-traffic-read-inspect-local-accept-calibration-v1") => {
            exit_for_result(
                run_role_binding_real_traffic_read_inspect_local_accept_calibration_v1(args),
        ...
        Some("role-binding-real-traffic-git-control-output-evidence-v1") => exit_for_result(
        ...
        Some("role-binding-real-traffic-git-control-admission-audit-v1") => exit_for_result(
            run_role_binding_real_traffic_git_control_admission_audit_v1(args),
            "try: nando-cli role-binding-real-traffic-git-control-admission-audit-v1 [registry-config-json] [evidence-trace-jsonl] [history-jsonl] [audit-report-json]",
        ),
        Some("role-binding-real-traffic-git-control-safe-policy-promote-v1") => exit_for_result(
            run_role_binding_real_traffic_git_control_safe_policy_promote_v1(args),
            "try: nando-cli role-binding-real-traffic-git-control-safe-policy-promote-v1 [base-registry-json] [evidence-trace-jsonl] [calibration-report-json] [promoted-registry-json] [promoted-trace-jsonl] [promote-report-json] [provider-cost-microusd]",
        ),
        ...
        Some("role-binding-real-traffic-serving-ops-payload-dry-run-v1") => exit_for_result(
            ...
            "try: nando-cli role-binding-real-traffic-serving-ops-payload-dry-run-v1 [history-jsonl] [registry-config-json] [trace-jsonl] [dry-run-report-json] [max-events]",
        ),
        Some("role-binding-real-traffic-serving-ops-profile-v1") => exit_for_result(
            run_role_binding_real_traffic_serving_ops_profile_v1(args),
            "try: nando-cli role-binding-real-traffic-serving-ops-profile-v1 [base-registry-json] [serving-ops-dry-run-trace-jsonl] [serving-ops-package-nwrb] [overlay-registry-json] [profile-report-json]",
        ),
        Some("role-binding-real-traffic-serving-ops-output-evidence-v1") => exit_for_result(
            run_role_binding_real_traffic_serving_ops_output_evidence_v1(args),
            "try: nando-cli role-binding-real-traffic-serving-ops-output-evidence-v1 [input-trace-jsonl] [codex-sessions-root] [output-trace-jsonl] [evidence-report-json]",
        ),
        Some("role-binding-real-traffic-serving-ops-local-accept-calibration-v1") => {
            exit_for_result(
                run_role_binding_real_traffic_serving_ops_local_accept_calibration_v1(args),
        ...
        Some("role-binding-real-traffic-metrics-report-local-accept-calibration-v1") => {
            exit_for_result(
                run_role_binding_real_traffic_metrics_report_local_accept_calibration_v1(args),
                "try: nando-cli role-binding-real-traffic-metrics-report-local-accept-calibration-v1 [registry-config-json] [evidence-trace-jsonl] [calibration-report-json]",
            )
        }
        Some("role-binding-real-traffic-metrics-report-admission-calibration-v1") => {
            exit_for_result(
                run_role_binding_real_traffic_metrics_report_admission_calibration_v1(args),
                "try: nando-cli role-binding-real-traffic-metrics-report-admission-calibration-v1 [evidence-trace-jsonl] [history-jsonl] [admission-report-json]",
            )
        }
        Some("role-binding-real-traffic-metrics-report-admission-safe-policy-promote-v1") => {
            exit_for_result(
                run_role_binding_real_traffic_metrics_report_admission_safe_policy_promote_v1(args),
                "try: nando-cli role-binding-real-traffic-metrics-report-admission-safe-policy-promote-v1 [base-registry-json] [evidence-trace-jsonl] [admission-report-json] [promoted-registry-json] [promoted-trace-jsonl] [promote-report-json] [provider-cost-microusd] [history-jsonl]",
            )
        }
        Some("role-binding-real-traffic-metrics-report-safe-policy-promote-v1") => exit_for_result(
            run_role_binding_real_traffic_metrics_report_safe_policy_promote_v1(args),
            "try: nando-cli role-binding-real-traffic-metrics-report-safe-policy-promote-v1 [base-registry-json] [evidence-trace-jsonl] [calibration-report-json] [promoted-registry-json] [promoted-trace-jsonl] [promote-report-json] [provider-cost-microusd]",
        ),
        ...
        Some("role-binding-real-traffic-planning-next-step-local-accept-calibration-v1") => {
            exit_for_result(
                run_role_binding_real_traffic_planning_next_step_local_accept_calibration_v1(args),
                "try: nando-cli role-binding-real-traffic-planning-next-step-local-accept-calibration-v1 [registry-config-json] [artifact-progress-trace-jsonl] [calibration-report-json]",
            )
        }
        Some("role-binding-real-traffic-planning-next-step-admission-calibration-v1") => {
            exit_for_result(
                run_role_binding_real_traffic_planning_next_step_admission_calibration_v1(args),
                "try: nando-cli role-binding-real-traffic-planning-next-step-admission-calibration-v1 [artifact-progress-trace-jsonl] [history-jsonl] [admission-report-json]",
            )
        }
        ...
        Some("role-binding-real-traffic-agent-control-admission-audit-v1") => exit_for_result(
            run_role_binding_real_traffic_agent_control_admission_audit_v1(args),
            "try: nando-cli role-binding-real-traffic-agent-control-admission-audit-v1 [admission-report-json] [feedback-report-json] [audit-report-json]",
        ),
        Some("role-binding-real-traffic-agent-control-safe-policy-promote-v1") => exit_for_result(
            run_role_binding_real_traffic_agent_control_safe_policy_promote_v1(args),
            "try: nando-cli role-binding-real-traffic-agent-control-safe-policy-promote-v1 [agent-control-registry-json] [evidence-trace-jsonl] [admission-report-json] [promoted-trace-jsonl] [promote-report-json] [provider-cost-microusd] [history-jsonl]",
        ),
        ...
        Some("role-binding-real-traffic-conditional-admission-audit-v1") => exit_for_result(
            run_role_binding_real_traffic_conditional_admission_audit_v1(args),
            "try: nando-cli role-binding-real-traffic-conditional-admission-audit-v1 [registry-config-json] [evidence-trace-jsonl] [history-jsonl] [audit-report-json]",
        ),
        Some("role-binding-real-traffic-conditional-safe-policy-promote-v1") => exit_for_result(
            run_role_binding_real_traffic_conditional_safe_policy_promote_v1(args),
            "try: nando-cli role-binding-real-traffic-conditional-safe-policy-promote-v1 [base-registry-json] [evidence-trace-jsonl] [calibration-report-json] [promoted-registry-json] [promoted-trace-jsonl] [promote-report-json] [provider-cost-microusd] [history-jsonl]",
        ),
        Some("role-binding-real-traffic-conditional-safe-policy-promote-v2") => exit_for_result(
            run_role_binding_real_traffic_conditional_safe_policy_promote_v2(args),
            "try: nando-cli role-binding-real-traffic-conditional-safe-policy-promote-v2 [base-registry-json] [evidence-trace-jsonl] [promoted-registry-json] [promoted-trace-jsonl] [promote-report-json] [provider-cost-microusd] [history-jsonl]",
        ),
        ...
        Some("role-binding-real-traffic-mixed-admission-audit-v1") => exit_for_result(
            run_role_binding_real_traffic_mixed_admission_audit_v1(args),
            "try: nando-cli role-binding-real-traffic-mixed-admission-audit-v1 [registry-config-json] [evidence-trace-jsonl] [history-jsonl] [audit-report-json]",
        ),
        ...
        Some("role-binding-real-traffic-mixed-safe-policy-promote-v2") => exit_for_result(
            run_role_binding_real_traffic_mixed_safe_policy_promote_v2(args),
            "try: nando-cli role-binding-real-traffic-mixed-safe-policy-promote-v2 [base-registry-json] [evidence-trace-jsonl] [calibration-report-json] [promoted-registry-json] [promoted-trace-jsonl] [promote-report-json] [provider-cost-microusd] [history-jsonl]",
        ),
        Some("role-binding-real-traffic-mixed-safe-policy-promote-v3") => exit_for_result(
            run_role_binding_real_traffic_mixed_safe_policy_promote_v3(args),
            "try: nando-cli role-binding-real-traffic-mixed-safe-policy-promote-v3 [base-registry-json] [evidence-trace-jsonl] [admission-audit-report-json] [promoted-registry-json] [promoted-trace-jsonl] [promote-report-json] [provider-cost-microusd] [history-jsonl]",
        ),
        ...
        Some("role-binding-real-traffic-edit-safe-policy-promote-v2") => exit_for_result(
            run_role_binding_real_traffic_edit_safe_policy_promote_v2(args),
            "try: nando-cli role-binding-real-traffic-edit-safe-policy-promote-v2 [base-registry-json] [evidence-trace-jsonl] [admission-report-json] [promoted-registry-json] [promoted-trace-jsonl] [promote-report-json] [provider-cost-microusd] [history-jsonl]",
        ),
        ...
        Some("role-binding-real-traffic-feedback-loop-v1") => exit_for_result(
            ...
            "try: nando-cli role-binding-real-traffic-feedback-loop-v1 [forecast-report-json] [edit-dry-run-report-json] [verification-audit-report-json] [feedback-report-json] [planning-dry-run-report-json] [planning-local-accept-calibration-report-json] [planning-verification-audit-report-json] [agent-control-admission-calibration-report-json] [agent-control-safe-policy-audit-report-json] [mixed-safe-policy-audit-report-json] [read-inspect-dry-run-report-json] [read-inspect-verification-audit-report-json] [metrics-dry-run-report-json] [metrics-verification-audit-report-json] [test-output-parse-window-audit-report-json]\n     note: route-specific conditional/mixed/retrieval-lookup/style-brevity/metrics-report/git-control/serving-ops/test-output-parse reports are auto-loaded from default artifact paths when present; audits whose total_llm_calls differ from the forecast window are excluded and reported",
        ),
        ...
        Some("role-binding-real-traffic-agent-loop-profile-registry-v1") => exit_for_result(
            ...
            "try: nando-cli role-binding-real-traffic-agent-loop-profile-registry-v1 [feedback-report-json] [cpu-operator-catalog-json] [agent-loop-profile-registry-report-json]",
        ),
