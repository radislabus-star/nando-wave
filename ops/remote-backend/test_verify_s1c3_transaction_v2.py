...
MODULE_PATH = Path(__file__).with_name("verify_s1c3_transaction_v2.py")
...
class TransactionVerifierTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.quiescence = quiescence_receipt()
    ...
    def test_remote_executor_has_no_build_command_after_quiescence(self) -> None:
        executor = Path(__file__).with_name("s1c3_remote_transaction_v2.py").read_text(
            encoding="utf-8"
        )
