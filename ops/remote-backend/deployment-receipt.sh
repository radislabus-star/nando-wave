...
CONFIG_PATHS="${NANDO_DEPLOY_RECEIPT_CONFIGS-/etc/nando-gateway/nginx.conf /etc/nando-wave/roles/response-learning.env /usr/local/bin/nando-live-transition-gate}"
