#!/usr/bin/env python3
"""Fail-closed verifier for the frozen S1C-3 V6 transaction receipt."""
...
SCHEMA = "nando.s1c3-transaction-receipt.v6"
...
def verify_preparation(directory: Path) -> dict[str, Any]:
    ...
    if quiescence["verdict"] == "TIMEOUT":
        ...
        require_exact(state.get("schema"), "nando.s1c3-state.v6", "timeout_state_schema")
        ...
        return {
            "schema": "nando.s1c3-verification.v6",
            "valid": True,
            "authority": False,
...
def main() -> int:
    ...
    try:
        ...
        print(json.dumps({"schema": "nando.s1c3-verification.v6", "valid": False,
