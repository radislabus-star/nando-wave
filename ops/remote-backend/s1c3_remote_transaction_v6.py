#!/usr/bin/env python3
"""Root-only remote executor for the preregistered S1C-3 V6 transaction."""
...
PAPER_COMMIT = "8c30a2cf2b122ab1a46b08e748c7d0ee6a08820b"
PAPER_MANIFEST_ROOT = "1e6bf54224ca2e46ff2071787131c56252bef40b728e502f72c21694c951c784"
PAPER_VERIFICATION_SHA256 = "6261d75f362275679637d2b50d947dc02a5a9d7eac1c282e118ee879455a57dc"
...
OWNERSHIP_SCHEMA = "nando.s1c3-oracle-ownership-receipt.v6"
OWNERSHIP_ROW_SCHEMA = "nando.s1c3-oracle-ownership-row.v6"
QUIESCENCE_SCHEMA = "nando.s1c3-quiescence-receipt.v6"
CONTAMINATION_SCHEMA = "nando.s1c3-measurement-contamination-receipt.v6"
RESOURCE_SCHEMA = "nando.s1c3-resource-receipt.v6"
PARITY_SCHEMA = "nando.s1c3-parity-receipt.v6"
PREPARATION_SCHEMA = "nando.s1c3-transaction-preparation.v6"
RECEIPT_SCHEMA = "nando.s1c3-transaction-receipt.v6"
STATE_SCHEMA = "nando.s1c3-state.v6"
PENDING_SCHEMA = "nando.s1c3-pending-receipt.v6"
...
def interval_sample(start: dict[str, Any], end: dict[str, Any]) -> dict[str, Any]:
    ...
    if start["process_races"] or end["process_races"]:
        blockers.append("process_observation_race")
...
def wait_for_quiescence(
    ...
    receipt = {
        ...
        "snapshot_schema": "single-proc-stat-snapshot-four-cpus-v1",
...
class MeasurementMonitor:
    def __init__(
        ...
        self.thread = threading.Thread(target=self._loop, name="s1c3-v6-monitor", daemon=True)
...
def run_oracle_ownership_probe(
    ...
    probe_code = (
        "import json,os,sys;d=sys.argv[1];p=os.path.join(d,'.s1c3-v6-ownership-probe');"
        "fd=os.open(p,os.O_WRONLY|os.O_CREAT|os.O_EXCL,0o600);"
        "os.write(fd,b's1c3-v6\\n');os.fsync(fd);os.close(fd);s=os.stat(p);os.unlink(p);"
    ...
    probe_path = workspace / ".s1c3-v6-ownership-probe"
    ...
    try:
        ...
        if measurement_error is not None:
            write_json(
                ...
                {
                    "schema": "nando.s1c3-measurement-failure.v6",
                    "observed_at": utc_now(),
        ...
        write_json(root / "preflight-failure.json", {"schema": "nando.s1c3-preflight-failure.v6",
...
def execute(args: argparse.Namespace) -> int:
    ...
    expected_verification = {
        "schema": "nando.s1c3-predeployment-verification.v6",
        "valid": True,
        "authority": True,
...
def main() -> int:
    ...
    try:
        ...
        print(json.dumps({"schema": "nando.s1c3-executor-error.v6", "error": str(error)}, sort_keys=True), file=sys.stderr)
        return 2
