#!/usr/bin/env python3
"""Fail-closed verifier for the frozen S1C-3 V3 transaction receipt."""
...
SCHEMA = "nando.s1c3-transaction-receipt.v3"
...
def verify_receipt(directory: Path) -> dict[str, Any]:
    ...
    return {
        "schema": "nando.s1c3-verification.v3",
        "valid": True,
        "verdict": verdict,
...
def main() -> int:
    ...
    try:
        ...
        print(json.dumps({"schema": "nando.s1c3-verification.v3", "valid": False,
