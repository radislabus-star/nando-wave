...
Usage:
  ...
  nando-provider-bridge-upstream-config.sh /etc/nando-wave/phase-center.env set --base-url URL --api-key-stdin [--provider NAME] [--allow-real-probe 0|1]
...
print_status() {
  local base_url provider allow_probe has_key verdict report raw_key
