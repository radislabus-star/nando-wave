...
require_contains docs/GOAL.md "cell32_settle_link_projection_accuracy"
...
require_contains docs/GOAL.md "settle_link_projection_gain"
require_contains docs/GOAL.md "settle_link_shuffle_accuracy"
...
require_contains docs/GOAL.md "settle_link_coupling_drop"
require_contains docs/GOAL.md "settle_link_phase_drop"
require_contains docs/GOAL.md "settle_link_wrong_pair_drop"
...
require_contains docs/GOAL.md "settle_link_no_shortcut_control"
...
require_contains docs/GOAL.md "rejected as architectural direction v6"
require_contains docs/GOAL.md "partial candidate architectural direction v7"
require_contains docs/GOAL.md "organ128_modadd_component_link_candidate"
require_contains docs/GOAL.md "organ128_modadd_seed_sweep_candidate"
require_contains docs/GOAL.md "organ_state_runtime_key_link"
require_contains docs/GOAL.md "organ_state_pair_link_state"
require_contains docs/GOAL.md "organ_state_pair_link_readout_tick"
require_contains docs/GOAL.md "settle_bus_tick_with_carrier"
require_contains docs/GOAL.md "raw pair-link vector was rejected"
require_contains docs/GOAL.md "third neutral readout tick"
...
require_contains docs/GOAL.md "min_settle_link_wrong_pair_drop"
require_contains docs/GOAL.md "реальный candidate circuit seed"
require_contains docs/GOAL.md "Межкомпонентная link-свертка"
require_contains docs/GOAL.md "Прямая попытка перенести v5 link-сигнал"
require_contains docs/GOAL.md "Первый перенос v5-сигнала в runtime state"
require_contains docs/GOAL.md "Переходы \"клетка предыдущего tick -> клетка текущего tick\""
require_contains docs/GOAL.md "Третий нейтральный readout tick"
